...
/// </summary>
public class LiquidLT : MonoBehaviour {
    ...
    private RobotLT liquidHandler; // Container which holds liquid.
    ...
    public RobotLT getLiquidHandler()
    {
        return this.liquidHandler;
    }

    public void setLiquidHandler(RobotLT liquidContainer)
    {
    ...
    {        
        ...
        this.getLiquid().AddComponent<ParticlePositionStateLT>();
    }
                                                    ...
                                                    Dictionary<string, float> particleDictionary)
    {
        ...
        ParticlePositionStateLT pps = this.getLiquid().GetComponent<ParticlePositionStateLT>();
