...
void GazeboGraspFix::OnUpdate() {
    ...
    for (gripCntIt = this->gripCounts.begin(); gripCntIt != this->gripCounts.end(); ++gripCntIt){
        ...
        for (pointIt=initColls.begin(); pointIt!=initColls.end(); ++pointIt)
        {
            ...
            ignition::math::Vector3d currContactWorldPose=_currContactWorldPose.Translation();
            ...
            ignition::math::Vector3d newObjDist= currContactWorldPose - currObjWorldPose.Pos(); // new distance from contact to object
...
bool GazeboGraspFix::checkGrip(const std::vector<ignition::math::Vector3d>& forces, float minAngleDiff, float lengthRatio){
    ...
    for (it1=forces.begin(); it1!=forces.end(); ++it1){
        ...
        for (it2=it1+1; it2!=forces.end(); ++it2){
            ...
            /*ignition::math::Vector3 _v1=v1;
            ignition::math::Vector3 _v2=v2;
            _v1/=l1;
            _v2/=l2;
...
void GazeboGraspFix::OnContact(const ConstContactsPtr &_msg)
{
    ...
    for (int i = 0; i < _msg->contact_size(); ++i) {
        ...
        if ((collision1 && !collision1->IsStatic()) && (collision2 && !collision2->IsStatic()))
        {
            ...
            ignition::math::Matrix4d worldToLinkInv = worldToLink.Inverse();
            ignition::math::Matrix4d contactInLocal = worldToLinkInv * worldToContact;
            ...
            /*ignition::math::Vector3 sDiff=avgPos-linkWorldPose.pos;
            ...
            ignition::math::Vector3 lX=linkWorldPose.rot.GetXAxis();    
            ignition::math::Vector3 lY=linkWorldPose.rot.GetYAxis();    
            ignition::math::Vector3 lZ=linkWorldPose.rot.GetZAxis();    
